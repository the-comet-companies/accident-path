  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center gap-1.5 text-sm font-semibold font-sans text-amber-600 hover:text-amber-700 transition-colors min-h-[44px] sm:min-h-0"
      >
        {triggerLabel}
      </button>
      ...
      <dialog
        ...
        className="m-auto w-full max-w-md rounded-2xl border border-neutral-100 bg-white p-0 shadow-2xl backdrop:bg-black/40 backdrop:backdrop-blur-sm open:animate-fade-in"
      >
